...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: !_isSaving && _currentPage == 0,
      onPopInvoked: (didPop) {
        if (didPop) return;
        if (_isSaving) {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('${_currentPage + 1} of 3',
                        style: const TextStyle(
                            color: AppTheme.gray, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
        ...
        children: [
          Center(
            child: Icon(Icons.person_outline,
                size: 80, color: AppTheme.navy700.withOpacity(0.2)),
          ),
          const SizedBox(height: 32),
          const Text('Welcome to TradeWorks!',
              style: TextStyle(
          ...
          const Text(
              'Let\'s set up your profile so pros can contact you when needed.',
              style: TextStyle(color: AppTheme.ink, fontSize: 15, height: 1.4)),
          const SizedBox(height: 32),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text(
              'Add your primary residence. You can manage multiple addresses later.',
              style: TextStyle(color: AppTheme.ink, fontSize: 15, height: 1.4)),
          const SizedBox(height: 32),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text(
              'Get timely updates when your pro is on the way or sends a message.',
              style: TextStyle(color: AppTheme.ink, fontSize: 15, height: 1.4)),
          const SizedBox(height: 32),
          Container(
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: AppTheme.tealTint, shape: BoxShape.circle),
